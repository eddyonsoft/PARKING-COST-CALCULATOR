...
describe('Long-Term Surface Parking ->', async () => {
    ...
    it('calculate cost for 1/2 hour', async () => { 
        ...
        await setParkingLot('#ParkingLot', 'Long-Surface');
    ...
    // total for 7 days = for 7 days $60 + $10 * 2
